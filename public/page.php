...
<body data-aos-easing="ease-out-back" data-aos-duration="1500" data-aos-delay="0">
    ...
    <section id="section05" class="demo">
        <h1
            ...
            <span class="tagline">Great food</span>
            <span class="punchline"> Always</span></h1>
        <a href="#about"><span></span></a>
    </section>

    <selection class="home-about">
    ...
    <div class="content">
        ...
        <h2>Marina Ćavar i Mila Lovrić</h2>
        <p>Zanimanje: studentice računarstna<br>
        email: marina.cavar@fsre.sum.ba<br>
               mila.lovric@fsre.sum.ba</p>
        <a href="about"></a>
    </div>
    <div class="image">
...
<!---------- Start Cuisines---------->
    ...
    <div class="container-fluid" style="background:#58403f">
    ...
    <div class="container-fluid" style="background:#58403f;padding-bottom:30px;">
        <div class="row" id="row2">
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="hr-list">
                                <li class="d-flex justify-content-between">
                                    <span>Monday - Friday</span> <span>08:00 - 23:00 </span>
                                </li>
                                <li class="d-flex justify-content-between">
                                    <span>Saturday</span> <span>08:00 - 00:00 </span>
                                </li>
                                <li class="d-flex justify-content-between">
                                    <span>Sunday</span> <span>08:00 - 00:00 </span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <form class="navbar-form"
                                    ...
                                    <div class="input-group add-on align-items-center d-flex">
                                        <input class="form-control" name="EMAIL" placeholder="Your Email address"
                                            ...
                                            onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Your Email add'
                                            required="get" type="email">
