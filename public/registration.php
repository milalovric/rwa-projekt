...
<body>
    ...
    if (isset($_REQUEST['email'])){
        ...
        $query = "INSERT into `customer` ( name, password, email,address,phone) VALUES ('$name', '$password', '$email','$address','$phone')";
    ...
    <div class="container" id="container">
        <div class="">
            <form action="" name="registration" method="post">
                ...
                <p style="font-weight:bold">Want to login? <a href='login.php' style="color:#black">Login here</a></p>
